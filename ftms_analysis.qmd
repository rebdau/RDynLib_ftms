...
```{r}
sample_data_ftms <- read_xlsx("data/ftms_data_files.xlsx") |>
    as.data.frame()
file <- "data/mzML/"
...
save(ftms, file = "data/ftms2.RData")
```

```{r}
load(file = "data/ftms2.RData")
```
...
dr <- "images/ftms/"
dir.create(dr, showWarnings = FALSE, recursice = TRUE)
