...
In this quarto document we create flattened pseudo-MS/MS spectra from a `Spectra`
object containing one MSn tree per feature, with up to four fragmentation levels (MS2-MS4). The `Spectra object was created in the
