...
```{r}
load(file.path(pth, "data", "ftms_new_settings.RData"))
class(ftms)
```
...
The percentage of features with at least one MS2 is 8.19%
...
ids1 <- c("FT0413", "FT0416")
a_chr1 <- featureChromatograms(ftms, features = ids1)

plot(a_chr1[1])
abline(v = 221.347, col = "red", lty = 2)   # RT de l'MS2

plot(a_chr1[2])
abline(v = 576.601, col = "red", lty = 2)

```

```{r}
# Example 2 : FT2594 et FT2595
ids2 <- c("FT2594", "FT2595")
a_chr2 <- featureChromatograms(ftms, features = ids2)

plot(a_chr2[1])
abline(v = 895.801, col = "red", lty = 2)

plot(a_chr2[2])
abline(v = 886.761, col = "red", lty = 2)
