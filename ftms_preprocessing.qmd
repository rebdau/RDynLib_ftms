...
save(ftms, file = "C:/Users/amentag/Desktop/Rcodes/RDynLib_ftms/data/ftms_final.RData")
```

```{r}
load(file = "C:/Users/amentag/Desktop/Rcodes/RDynLib_ftms/data/ftms_final.RData")
```
