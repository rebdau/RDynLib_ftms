---
title: "Preprocessing of FTMS LC-MSn data"
author:
  - name: Ahlam Mentag
...
Now we import our dataset. The `MsExperiment::readMsExperiment()`function creates an `MsExperiment`object, which we will call here `ftms`.
